...
from src.signals import generate_mean_reversion_signal
...
def run_mean_reversion_experiment(
    ...
    """
    Run a mean-reversion strategy experiment on SPY.

    Parameters
    ----------
    lookback : int, default=20
        Moving-average window used to identify mean reversion.
    ...
    price = generate_mean_reversion_signal(
        price,
        lookback=lookback,
    )
